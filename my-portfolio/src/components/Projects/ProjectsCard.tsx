      ...
      <div className="flex flex-row justify-center items-center gap-5">
        ...
        <div className="flex flex-col justify-center items-center w-2/4 gap-5">
          ...
          <div className="flex flex-row gap-2">
            ...
            <button onClick={() => moveToLink(project.link)} className=' bg-white text-black font-semibold p-3 rounded-sm hover:bg-gradient-to-tr from-[#E1A0E7] to-[#CD60D8]'>YouTube</button>
            {
